...
class Product(mysql_db.Model):
    ...
    p_description = mysql_db.Column(mysql_db.String(10))
    p_location = mysql_db.Column(mysql_db.String(50))
    c_id = mysql_db.Column(mysql_db.String(20))

    def __init__(self, p_id, p_name="", p_price=0, p_description="", p_location = "",c_id=""):
        self.p_id = p_id
        self.p_name = p_name
    ...
    def __repr__(self):
        return '<Product %r, %r, %r, %r, %r, %r>' % (self.p_id, self.p_name, self.p_price, self.p_description, self.p_location,self.c_id)
